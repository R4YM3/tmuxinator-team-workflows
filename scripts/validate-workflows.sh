...
HELPER_FILE="$REPO_DIR/templates/helpers/workflow.rb"

REPOSITORIES_ROOT="${REPOSITORIES_ROOT:-$REPO_DIR}"
TEAM_WORKFLOWS_REPO_DIR="${TEAM_WORKFLOWS_REPO_DIR:-$REPO_DIR}"
